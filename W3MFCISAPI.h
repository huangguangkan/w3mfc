...
//Methods
  ...
  void                          FreeMapEntries();
  void                          SetError(IW3MFCError* pError);
...
protected:
  ...
  IW3MFCError*     m_pError;        //The Error reporting interface
  CW3MFCSettings*  m_pSettings;     //The settings
  CCriticalSection m_CS;            //Thread protects access to the hash table from multiple threads
};

#endif //#ifndef __W3MFCISAPI_H__
